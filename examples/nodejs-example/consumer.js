        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    consumer.onReady = function (info, metadata) {
                        consumer.kafkaClient.assign([{ topic: 'test', partition: 0, offset: 1 }]);
                    };
                    return [4 /*yield*/, consumer.init()];
                case 1:
                    _a.sent();
                    consumer.logs$.subscribe(function (log) {
                        // console.log(log.message);
                    });
                    consumer.errors$.subscribe(function (err) {
                        console.error(err);
                    });
                    consumer.messages$.subscribe(function (msg) {
                        console.log(msg);
                    });
                    consumer.consume();
                    return [2 /*return*/];
